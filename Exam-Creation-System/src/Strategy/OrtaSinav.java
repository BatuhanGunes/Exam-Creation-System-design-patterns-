...
public class OrtaSinav extends ZorlukAyari {

	private static OrtaSinav obj=null;
	...
	public static OrtaSinav getObj(){
		if(obj==null){
            obj=new OrtaSinav();
        }return obj;
	}
	...
	public void soruSayisiHesapla() {
		...
		if(sinavOlustur.toplamSoruSayisi() == hesaplananToplamSoruSayisi()) {
			...
			setOrtaSoruSayisi(ortaSoruSayisi-gecici);
		}else {
	...
	public int kolaySoruSayisiHesapla() {
		kolaySoruSayisi = (int)(sinavOlustur.toplamSoruSayisi()/10*3);
		return kolaySoruSayisi;
	}
	public int ortaSoruSayisiHesapla() {
		ortaSoruSayisi =(int)(sinavOlustur.toplamSoruSayisi()/10*5);
		return ortaSoruSayisi;
	}
