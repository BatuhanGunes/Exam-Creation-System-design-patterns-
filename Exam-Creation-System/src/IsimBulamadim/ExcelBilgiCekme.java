...
public class ExcelBilgiCekme {
    ...
    private static ExcelBilgiCekme obj;	
    private ExcelBilgiCekme(){
    
    }
    public static ExcelBilgiCekme getObj() {
    	if(obj == null) {
    		 obj = new ExcelBilgiCekme();
    	}return obj;
    }
