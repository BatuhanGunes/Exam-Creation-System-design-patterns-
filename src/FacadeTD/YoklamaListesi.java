...
public class YoklamaListesi extends JFrame {
	...
	private void jasperReportIslemleri(LinkedList<Map<String,Object>> dataSource,int dosyaAdiNumarasi) throws JRException {
		...
		JasperExportManager.exportReportToPdfFile(filledReport,getExportPath()+"/"+ SinavCikti.getTextFieldSinavAdi().getText().toString()+pdfAdi.get(dosyaAdiNumarasi)+"YoklamaListesi.pdf");	
		dataSource.clear();
	}
}
